                ...
                if (colorTable != null)
                {
                    using (var antiAlias = new UseAntiAlias(graphics))
                    {
                        ...
                        if (item.ButtonPressed)
                        {
                            ...
                            DrawInnerButtonBorder(graphics,
                                dropDownButtonRectangle,
                                colorTable.ButtonSelectedHighlightBorder);
                        ...
                        if (e.Item.Owner is MenuStrip)
                        {
                            DrawArrow(new ToolStripArrowRenderEventArgs(graphics,
                                item,
                                dropDownButtonBounds,
                                colorTable.MenuItemText,
                                ArrowDirection.Down));
                        }
                    ...
                    if (e.ToolStrip is MenuStrip)
                    {
                        if (item.Selected && item.Pressed == false)
                        {
                            ...
                            ControlPaint.DrawBorder(e.Graphics,
                                bounds,
                                colorTable.MenuItemTopLevelSelectedBorder,
        ...
        protected override void OnRenderOverflowButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            if (item.Selected == false && item.Pressed == false)
            {
                ...
                if (colorTable != null)
                {
                    ...
                    {
                        x = bRightToLeft ? -2 : 0;
                        RenderOverflowButtonLine(graphics,
                            colorTable.ToolStripText,
                            arrowRectangle.Right - 6,
                            arrowRectangle.Y - 2,
                            arrowRectangle.Right - 2,
                            arrowRectangle.Y - 2);
                        RenderOverflowButtonLine(graphics,
                            colorTable.ToolStripGradientMiddle,
                            arrowRectangle.Right - 5 + x,
                            arrowRectangle.Y - 1,
                            arrowRectangle.Right - 1 + x,
                            arrowRectangle.Y - 1);
                    }
                    else
                    {
                        RenderOverflowButtonLine(graphics,
                            ...
                            arrowRectangle.Y,
                            arrowRectangle.X,
                            arrowRectangle.Bottom - 1);
                        RenderOverflowButtonLine(graphics,
                            colorTable.ToolStripGradientMiddle,
                            arrowRectangle.X + 1,
                            arrowRectangle.Y + 1,
                            arrowRectangle.X + 1,
                            arrowRectangle.Bottom);
                    }
                }
            }
        }
            ...
            else
            {
                ...
                if (backgroundRectangle.Width > 0 && backgroundRectangle.Height > 0)
                {
                    if (e.ToolStrip is StatusStrip)
                    {
                        ...
                        var upperRectangle = new Rectangle(backgroundRectangle.X,
                        ...
                        var lowerRectangle = new Rectangle(backgroundRectangle.X,
                            backgroundRectangle.Height - y2,
                            backgroundRectangle.Width,
                            y2);
