...
namespace GMap.NET.WindowsForms.Markers
{
    ...
    public class GMapMarkerTransparentGoogleGreen : GMapMarkerTransparent
    {
            ...
            : base(p)
        {
            ...
            IGMapTransparentBitmap shadow =
                GMapMarkerTransparent.LoadTransparentBitmap(ass.GetManifestResourceStream(resShadow));
            IGMapTransparentBitmap marker =
                GMapMarkerTransparent.LoadTransparentBitmap(ass.GetManifestResourceStream(resMarker));
