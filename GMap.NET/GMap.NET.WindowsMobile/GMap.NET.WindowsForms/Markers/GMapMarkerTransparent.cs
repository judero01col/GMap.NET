...
namespace GMap.NET.WindowsForms.Markers
{
    ...
    public abstract class GMapMarkerTransparent : GMapMarker
    {
        ...
        public override void OnRender(Graphics g)
        {
            for (Int32 i = 0; i < this.BitmapCount; i++)
            {
                ...
                System.Drawing.Rectangle dst = new System.Drawing.Rectangle(LocalPosition.X + bitmap.DrawOffset.X,
                    LocalPosition.Y + bitmap.DrawOffset.Y,
                    bitmap.Width,
                    bitmap.Height);
    ...
    public class WinCEImagingBitmap : IGMapTransparentBitmap
    {
        ...
        public WinCEImagingBitmap(Stream stream)
        {
            ...
            uint hresult = myImagingFactory.CreateImageFromBuffer(bytes,
                (uint)bytesLength,
            ...
            IBitmapImage bitmap;
            myImagingFactory.CreateBitmapFromImage(myImage,
                0,
                0,
                PixelFormatID.PixelFormat32bppARGB,
...
#pragma warning restore 0649
    ...
    interface IImage
    {
        ...
        uint Draw(IntPtr hdc, ref RECT dstRect,
            IntPtr srcRect); // "Correct" declaration: uint Draw(IntPtr hdc, ref Rectangle dstRect, ref Rectangle srcRect);
    ...
    interface IBitmapImage
    {
        ...
        uint LockBits(ref RECT rect, ImageLockMode flags, PixelFormatID pixelFormat,
            out BitmapImageData lockedBitmapData);
