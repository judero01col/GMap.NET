...
namespace GMap.NET.Internals
{
    ...
    public class Native
    {
        ...
        public static extern IntPtr SetPowerRequirement(string pvDevice, CedevicePowerStateState deviceState,
            uint deviceFlags, string pvSystemState, ulong stateFlags);
