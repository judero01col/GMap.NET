...
namespace GMap.NET.GPS
{
    ...
    public class GpsPosition
    {
        ...
        public DateTime? Time
        {
            get
            {
                return ((dwValidFields & GPS_VALID_UTC_TIME) != 0)
                    ? ((DateTime?)new DateTime(stUTCTime.year,
                        stUTCTime.month,
                        stUTCTime.day,
                        stUTCTime.hour,
                        stUTCTime.minute,
                        stUTCTime.second,
                        stUTCTime.millisecond,
                        DateTimeKind.Utc))
                    : null;
            }
        }
        ...
        public IEnumerable<Satellite> GetSatellitesInView()
        {
            ...
            if ((dwValidFields & GPS_VALID_SATELLITES_IN_VIEW) != 0 && dwSatellitesInView != 0)
            {
                ...
                {
                    Satellite ret = new Satellite(rgdwSatellitesInViewPRNs[index],
        ...
        public float? EllipsoidAltitude
        {
            get
            {
                return ((dwValidFields & GPS_VALID_ALTITUDE_WRT_ELLIPSOID) != 0)
        ...
        public float? PositionDilutionOfPrecision
        {
            get
            {
                return ((dwValidFields & GPS_VALID_POSITION_DILUTION_OF_PRECISION) != 0)
        ...
        public float? HorizontalDilutionOfPrecision
        {
            get
            {
                return ((dwValidFields & GPS_VALID_HORIZONTAL_DILUTION_OF_PRECISION) != 0)
        ...
        public float? VerticalDilutionOfPrecision
        {
            get
            {
                return ((dwValidFields & GPS_VALID_VERTICAL_DILUTION_OF_PRECISION) != 0)
