namespace MSR.CVE.BackMaker.ImagePipeline
{
    public class RenderedTileSource : IDisplayableSource
    {
        ...
        public IFuture GetUserBounds(LatentRegionHolder latentRegionHolder, FutureFeatures features)
        {
            ...
            return new MemCacheFuture(this.cachePackage.asyncCache,
                Asynchronizer.MakeFuture(this.cachePackage.computeAsyncScheduler,
                    new MemCacheFuture(this.cachePackage.boundsCache,
        ...
        public IFuturePrototype GetImagePrototype(ImageParameterTypeIfc parameterType, FutureFeatures features)
        {
            ...
            IFuturePrototype prototype = new ApplyPrototype(new RenderedTileFetch(this.namingScheme),
